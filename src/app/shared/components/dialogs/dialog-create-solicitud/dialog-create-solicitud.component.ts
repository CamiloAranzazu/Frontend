...
@Component({
  selector: 'app-dialog-create-solicitud',
  standalone: true,
  ...
  templateUrl: './dialog-create-solicitud.component.html',
  styleUrl: './dialog-create-solicitud.component.scss',
  providers: [DynamicDialogRef]
})
export class DialogCreateSolicitudComponent implements OnInit{
  products: any[] = [];
